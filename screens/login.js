...
class LoginScreen extends React.Component {
  ...
  constructor(props){
    super(props);
    this.state = {
      email: 'goodGrief@griefNapkin.com',
      password: 'grievingCoder',
      errors: [],
      loading: false,
    }
  }
  ...
  render(){
    ...
    return (
      <KeyboardAvoidingView 
        ...
        keyboardVerticalOffset={Platform.select({ios: 0, android: sizes.base*2})} 
        behavior="padding">
        <Block padding= {[0,sizes.base*2]}>
         ...
         <Block middle>
            ...
            <Button gradient onPress={this.onLoginClicked}>
              {this.state.loading ? 
                <DotIndicator color = {colors.white} count = {4} size = {sizes.base*0.5}/> : 
